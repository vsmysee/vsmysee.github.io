...
title: 公司分享
---
这里汇聚了一大堆乱七八糟，来源于公司内部的一次分享，以后可能会拆成很多个主题再写，关于编程冰山，我可能只在某个角落里瞎玩玩而已,我始终在试图寻找编程的本质，如爱因斯坦的质问：我想要知道上帝是如何创造世界的，其他就不重要了。哪天能够顿悟呢？越深入越白痴。
...
在IDEA里我其实不需要vim那么全的特性，不遵守vim的规则，只要能快速编辑java即可。如果敢兴趣请管住的一个oh my idea的项目，它模拟了部分vim用法但是编写java更迅速。
