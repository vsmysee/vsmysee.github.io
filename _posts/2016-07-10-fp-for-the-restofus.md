...
title: 傻瓜函数式编程
---
拷贝自[互联网](https://github.com/justinyhuang/Functional-Programming-For-The-Rest-of-Us-Cn/blob/master/FunctionalProgrammingForTheRestOfUs.cn.md),这是篇从考古模式来介绍函数式编程的文章,记录在本博客中,随时翻阅,计算机不同物理学,起码是人创造的,所以从历史中学习事倍功半,这篇文章的[英文版](http://www.defmacro.org/ramblings/fp.html)
